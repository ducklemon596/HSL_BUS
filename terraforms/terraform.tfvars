...
backend_vpc_connector_name = "bus-backend-vpc-conn"
backend_vpc_cidr_range     = "10.10.3.0/28"
redis_port                 = 6379
repo_name                  = "hsl-repo"
...
# KAFKA CONFIGURATION
# ============================================================================
# kafka_partition_count: Number of partitions for the Kafka topic (4 partitions)
...
# ============================================================================
# Docker images for the backend and frontend Cloud Run services
backend_image          = "asia-southeast1-docker.pkg.dev/hsl-bus-streaming-495014/hsl-repo/hsl-bus-backend:latest"
frontend_service_image = "asia-southeast1-docker.pkg.dev/hsl-bus-streaming-495014/hsl-repo/hsl-bus-frontend:latest"
# Memory: 512Mi provides good balance for Cloud Run services
...
# Max instances: Scale up to 2 for high load
